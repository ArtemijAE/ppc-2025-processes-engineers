...
- для вектора размера < 2 результат равен 0;
...
Использовано блочное распределение вектора между процессами. Вектор делится на непрерывные блоки равного размера. Для вектора размером `n` и `p` процессов:
...
- Генерация: детерминистичная последовательность от -100 до 100

## 7. Результаты и обсуждение

### 7.1 Корректность
Корректность проверена через 12 функциональных тестов, включая:
- Чередующиеся знаки
