...
const std::array<TestType, 27> kTestParam = {
    ...
    std::make_tuple(4, "alternating"),    std::make_tuple(5, "all_positive"),   std::make_tuple(2, "all_positive"),
    std::make_tuple(3, "alternating"),    std::make_tuple(6, "alternating"),    std::make_tuple(7, "alternating"),
    std::make_tuple(8, "all_positive"),   std::make_tuple(9, "all_positive"),   std::make_tuple(11, "alternating"),
    std::make_tuple(12, "all_positive"),  std::make_tuple(13, "alternating")};
