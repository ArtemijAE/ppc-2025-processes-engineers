...
std::vector<double> IlinAStrassenAlgorithmSEQ::naiveMultiply(
...
void IlinAStrassenAlgorithmSEQ::computeResultSubmatrices(
    const std::vector<std::vector<double>> &products,
...
std::vector<double> IlinAStrassenAlgorithmSEQ::strassenMultiply(
    const std::vector<double> &A, const std::vector<double> &B, int n) {
  ...
  auto products = computeStrassenProducts(A11, A12, A21, A22,
                                         B11, B12, B21, B22,
                                         half);
...
void IlinAStrassenAlgorithmSEQ::addMatrix(const std::vector<double> &A,
...
void IlinAStrassenAlgorithmSEQ::subtractMatrix(const std::vector<double> &A,
                                               const std::vector<double> &B,
                                               std::vector<double> &C, int n) {
  for (int i = 0; i < n * n; ++i) {
    C[i] = A[i] - B[i];
...
void IlinAStrassenAlgorithmSEQ::splitMatrix(const std::vector<double> &A,
...
void IlinAStrassenAlgorithmSEQ::joinMatrix(std::vector<double> &A,
